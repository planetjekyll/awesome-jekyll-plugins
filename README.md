...
- [**jekyll-imgix**](https://github.com/imgix/jekyll-imgix) ★45 (gem: [jekyll-imgix](https://rubygems.org/gems/jekyll-imgix)) -- Transform, optimize, and intelligently cache your entire image library for fast websites and apps. **Commercia**
...
- [**Jekyll Spaceship**](https://github.com/jeffreytse/jekyll-spaceship) ★10 (gem: [jekyll-spaceship](https://rubygems.org/gems/jekyll-spaceship)) -- A Jekyll plugin to provide powerful supports for table, mathjax, plantuml, youtube, vimeo, dailymotion, etc.

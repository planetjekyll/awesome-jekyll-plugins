...
- [**Multiple languaes**](https://github.com/kurtsson/jekyll-multiple-languages-plugin) ★935 (gem: [jekyll-multiple-languages-plugin](https://rubygems.org/gems/jekyll-multiple-languages-plugin)) by Martin Kurtsson -- I18n support for Jekyll and Octopress
